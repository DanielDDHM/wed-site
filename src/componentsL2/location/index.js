                ...
                <div className="col-md-12 col-12">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-7 col-md-12 col-12">
                        <div className="event-text">
                          <h3>Religiöse Zeremonie</h3>
                          <span>03. September 2022, 15:00 Uhr</span>
                  ...
                  <div className="event-wrap">
                    <div className="row">
                      ...
                      <div className="col-lg-7 col-md-12 col-12">
                        <div className="event-text">
                          <h3>Abendessen und lass uns tanzen</h3>
                          <span>03. September 2022, 21:00 Uhr</span>
                          <span>Im Tuniberghaus Tiegen</span>
                          <span>
                            Im Maierbrühl 2, 79112 Freiburg im Breisgau
                          </span>
