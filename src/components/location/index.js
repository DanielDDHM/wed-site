                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-7 col-md-12 col-12">
                                                <div className="event-text">
                                                    ...
                                                    <Button className="btn" onClick={toggle2}>Location</Button>
                                                    <Modal isOpen={modal2} toggle={toggle2} className={className}>
                                                        <ModalHeader toggle={toggle2}>Localização da Cerimonia religiosa</ModalHeader>
                                                        <ModalBody>
                                            ...
                                            <div className="col-lg-7 col-md-12 col-12">
                                                <div className="event-text event-text-2">
                                                    ...
                                                    <Modal isOpen={modal} toggle={toggle} className={className}>
                                                        <ModalHeader toggle={toggle}>Localização do salao de festas</ModalHeader>
                                                        <ModalBody>
                                                            <div className="location-map-2">
