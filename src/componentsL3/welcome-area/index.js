        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="welcome-content">
              ...
              <p>
                Temos a honra de convida-lós para o nosso casamento e juntos com
                vocês queremos tornar esse dia inesquecível.
              </p>
              <p>
                O AMOR É PACIENTE. O AMOR E BONDOSO. NÃO INVEJA, NÃO SE
                VANGLORIA, NÃO SE ORGULHA." (I CORINTIOS 19:4)
              </p>
              <div className="btn">
                <AnchorLink href="#rules">Regras</AnchorLink>
              </div>
              ...
              <Modal isOpen={modal2} toggle={toggle2} className={className}>
                ...
                <ModalBody>
                  <p class="text-post-title">
                    Contato Milene: +49 176 85583034
                  </p>
                  <p class="text-post-title">
                    Contato Kibrilha: +49 1575 2997750
                  </p>
                </ModalBody>
              </Modal>
